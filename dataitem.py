...
if __name__ == '__main__':
    ...
    # u = db.update("update uiadata.ut_users set password='670b14728ad9902aecba32e22fa4f6bd' WHERE LOGINID='2014800185' AND CARDID='220103198903232171'"))

    t = db.query("SELECT * FROM DLAKE_PERSONNEL_TEACHER WHERE GH='2014800185'")
    print(t)
